...
- [docs/DEPLOYMENT.md](docs/DEPLOYMENT.md) — generated artifacts, Netlify, verifying a build
...
cd site && netlify deploy --prod --dir .   # deploy
```

No test suite, no linter, no node/npm toolchain. After any change, rebuild and confirm
